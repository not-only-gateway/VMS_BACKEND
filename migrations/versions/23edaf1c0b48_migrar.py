...
Revision ID: 23edaf1c0b48
Revises: ef33d741b93d
Create Date: 2022-04-01 10:13:07.208618
...
revision = '23edaf1c0b48'
down_revision = 'ef33d741b93d'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('host', sa.Column('volume', sa.BigInteger(), nullable=True))
